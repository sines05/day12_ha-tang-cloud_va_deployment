/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ebead5f242618de9e775ea8cabcf3d86)
// Runtime types generated with workerd@1.20251011.0 2025-10-31 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UploadProcessor";
	}
	interface Env {
		...
		UPLOAD_PROCESSOR: DurableObjectNamespace<import("./src/index").UploadProcessor>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_API_KEY" | "ADMIN_PASSWORD">> {}
}
